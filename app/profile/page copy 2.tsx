...
import { User, Mail, Phone, MapPin, Save, Edit2, Loader2, CheckCircle2, AlertCircle, ArrowLeft, Camera } from "lucide-react";
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-8 text-center shadow-sm relative overflow-hidden">
            ...
            <div className="relative group mx-auto w-32 h-32 mb-6">
              ...
              <div className="w-full h-full bg-slate-100 rounded-2xl flex items-center justify-center text-4xl font-black shadow-xl ring-4 ring-blue-50 overflow-hidden relative">
                ...
                <label className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer text-white text-xs">
                  {uploading ? <Loader2 className="animate-spin" /> : <><Camera size={24} className="mb-1" /> เปลี่ยนรูป</>}
